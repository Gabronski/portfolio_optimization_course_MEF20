...
interest_rate = 0.2 #the itnerest rate we find, e.g EURIBOR + spread CDS BTP Italy
View(Mydataset)
...
Mydataset_given
Mymaxprobgiven<- maximization_problem_given(Mydataset_given,Duration_desired = 9.5)
Mymaxprobgiven
debug(maximization_problem_given)
